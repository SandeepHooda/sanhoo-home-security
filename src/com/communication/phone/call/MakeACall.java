...
public class MakeACall {
	...
	private static final Logger log = Logger.getLogger(MakeACall.class.getName());

	private static FetchOptions lFetchOptions = FetchOptions.Builder.doNotValidateCertificate().setDeadline(300d);
	private static URLFetchService fetcher = URLFetchServiceFactory.getURLFetchService();
	public static boolean call(String phoneNo, String messageID, String fromDevice) throws IOException {
		log.info("Hero making a call sms to "+phoneNo);
		String httpsURL  = "https://post-master.herokuapp.com/MakeACall?phone="+phoneNo+"&messageID="+messageID+"&fromNumber="+fromDevice+"&source=sanhoo-home-security";
